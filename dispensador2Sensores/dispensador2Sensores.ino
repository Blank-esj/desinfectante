...
const int releJabon = 3; // Relé para el jabón líquido
//const int releAgua = 2;  // Relé para el agua
...
void loop()
{
  ...
  {
    digitalWrite(releJabon, LOW); // Dispensamos jabon
  }
  Serial.print("d Agua: ");
  ...
  if (distancia <= 15.0)
  {
    ...
    servoMotor.write(180); // Dejamos de Dispensar agua
  }
  else
  {
    servoMotor.write(0); // Dejamos de dispensar agua
  }
  delay(50);
